...
export class AIController {
  ...
  generateTradingSignal = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      // USE THE ENHANCED STOCK DATA SERVICE to get comprehensive Yahoo Finance data
      let comprehensiveData: ComprehensiveFinancialData | null = null;
      try {
        console.log(`📊 Fetching comprehensive financial data using EnhancedStockDataService for ${symbol}`);

        // Use the enhanced service to get comprehensive data (returns data instead of void)
        const { enhancedStockDataService } = await import('../services/EnhancedStockDataService');
        comprehensiveData = await enhancedStockDataService.instance.getComprehensiveYahooFinanceData(symbol.toUpperCase());

        console.log(`✅ Retrieved comprehensive data using EnhancedStockDataService:`, {
        ...
        console.warn(`⚠️ Could not fetch comprehensive data for ${symbol} using EnhancedStockDataService, proceeding with basic data:`, error);
  ...
  generateDemoTradingSignal = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      try {
        ...
        console.warn(`⚠️ Could not fetch comprehensive data for demo ${symbol} using EnhancedStockDataService, proceeding with basic data:`, error);
        comprehensiveData = null;
      }
